...
<article id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
        ...
        <?php if ( $callie_video && has_post_thumbnail() ) : ?>
            ...
            <a class="post-thumbnail video" href="<?php echo esc_attr( $iframe_url ); ?>">
                ...
                <span class="play-icon">
                    <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/icons/play.png' ); ?>" alt="<?php echo esc_attr__( bloginfo('name') . ' play icon', 'callie'); ?>">
                </span>
            </a>
    ...
    <a class="read-more" href="<?php echo esc_url( get_permalink() ); ?>"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/icons/next.svg' ); ?>" alt="<?php echo esc_attr__( bloginfo('name') . ' read more', 'callie'); ?>"></a>
